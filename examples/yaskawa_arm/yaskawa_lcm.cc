...
YaskawaContactResultsToExternalTorque::YaskawaContactResultsToExternalTorque(
  ...
  this->DeclareVectorOutputPort(
      ...
      &YaskawaContactResultsToExternalTorque::OutputExternalTorque);
}

void YaskawaContactResultsToExternalTorque::OutputExternalTorque(
