...
class ConveyorGeometry final : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(ConveyorGeometry);
  ~ConveyorGeometry() final;
  ...
  static const ConveyorGeometry* AddToBuilder(
      systems::DiagramBuilder<double>* builder,
      const systems::OutputPort<double>& conveyor_state_port,
      geometry::SceneGraph<double>* scene_graph);

 private:
  explicit ConveyorGeometry(geometry::SceneGraph<double>*);
