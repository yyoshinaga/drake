...
class YaskawaCommandSender : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(YaskawaCommandSender)

  explicit YaskawaCommandSender(int num_joints = kYaskawaArmNumJoints);
