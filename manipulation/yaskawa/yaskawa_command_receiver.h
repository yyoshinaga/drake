...
///   @output_port{torque}
/// }
class YaskawaCommandReceiver : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(YaskawaCommandReceiver)

  explicit YaskawaCommandReceiver(int num_joints = kYaskawaArmNumJoints);
