...
class YaskawaStatusSender : public systems::LeafSystem<double> {
 public:
  DRAKE_NO_COPY_NO_MOVE_NO_ASSIGN(YaskawaStatusSender)

  explicit YaskawaStatusSender(int num_joints = kYaskawaArmNumJoints);
